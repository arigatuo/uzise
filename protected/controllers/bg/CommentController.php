...
class CommentController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Comment']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->autoid));
		}
    ...
    public function actionMultiAll(){
        if (isset($_POST['comment-grid_c0']) && !empty($_GET['action']) && in_array($_GET['action'],
            array('delete', 'show', 'hide')))
        {
            $del_comments = $_POST['comment-grid_c0'];
            ...
            if(is_array($del_comments) && count($del_comments)){
                ...
                Comment::model()->updateByPk($_comment_id_array, array('status'=>$_GET['action']));
            }
